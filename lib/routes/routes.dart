import 'package:e_commerce/app/pages/navigation/bottom_navigation.dart';
import 'package:e_commerce/models/transaction/transaction.dart';
import 'package:flutter/material.dart';

import '../app/pages/address/add_address/add_address_page.dart';
import '../app/pages/address/edit_address/edit_address_page.dart';
import '../app/pages/address/manage_address/manage_address_page.dart';
import '../app/pages/auth/forgot_password/forgot_password_page.dart';
import '../app/pages/auth/login/login_page.dart';
import '../app/pages/auth/register/register_page.dart';
import '../app/pages/checkout/checkout_page.dart';
import '../app/pages/payment/payment_page.dart';
import '../app/pages/payment_method/add_payment_method/add_payment_method_page.dart';
import '../app/pages/payment_method/edit_payment_method/edit_payment_method_page.dart';
import '../app/pages/payment_method/manage_payment_method/manage_payment_method_page.dart';
...
import '../app/pages/product/product_review/product_review_page.dart';
import '../app/pages/transaction/detail_transaction/detail_transaction_page.dart';
...
class NavigateRoute {
  static toDashboard({required BuildContext context}) {
    Navigator.of(context).popUntil((route) => route.isFirst);
    Navigator.of(context).popAndPushNamed(RouteName.kDashboard);
  }
  ...
  static toDetailProduct({required BuildContext context, required Product product}) {
    Navigator.of(context).pushNamed(RouteName.kDetailProduct, arguments: product);
  }
  ...
  static toDetailTransaction({required BuildContext context, required Transaction transaction}) {
    Navigator.of(context).pushNamed(RouteName.kDetailTransaction, arguments: transaction);
  }
}

final routes = {
  RouteName.kDashboard: (_) => const BottomNavigation(),
